...
public class CourseServiceImpl implements CourseService {
    ...
    @Override
    public Page<Course> getAllCourses(int pages) {
    ...
    @Override
    public Page<Course> findByTrainer(String trainer, int pages) {
        Pageable pageable = PageRequest.of(pages-1,1);
        return courseDao.findByTrainer(trainer,pageable);
    }

    @Cacheable(value = "findCoursesByName")
    @Override
    public Page<Course> findByName(String name,int pages) {
        Pageable pageable = PageRequest.of(pages-1,1);
        return courseDao.findByName(name,pageable);
    }

    @Cacheable(value = "findCoursesByNameAndTrainer")
    @Override
    public Page<Course> findByNameAndTrainer(String name, String trainer, int pages){
        Pageable pageable = PageRequest.of(pages-1,1);
        return courseDao.findByNameAndTrainer(name, trainer, pageable);
    }
